...
![Linux](https://img.shields.io/badge/WSL%2FUbuntu-E95420?style=for-the-badge&logo=ubuntu&logoColor=white)
...
| **Photo Gallery** | Image upload and gallery management app with Cloudinary storage and Google OAuth. | Django · PostgreSQL · Cloudinary · django-allauth |
| **Calorie Counter Max** | Daily calorie and nutrition tracking app with dark Tailwind UI. | Django · PostgreSQL · Tailwind |

---

## Currently Exploring
`React Native` · `Kubernetes` · `Microservices` · AI-assisted UI tooling (Trae, Windsurf, v0.dev)
...
[![GitHub](https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white)](https://github.com/winstone-1)
